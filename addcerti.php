...
<form action="submitcert.php" method="post" enctype="multipart/form-data">
...
<td><input type="text" name="certtitle" required></td>
<td><input type="text" name="dateissued" required></td>
</tr>
</table>
