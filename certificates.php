...
<div class="content">
<div class="intro">
<form action="editcerti.php" method="post">
<div class="controls">
<div style="text-align: right;"><span style="margin-right: 25%; width: 100%;">CERTIFICATES</span>
<input class="buttons" type="button" onclick="location.href='addcerti.php'" value="ADD"/>
