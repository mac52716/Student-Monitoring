...
$result = $conn->query("SELECT idno,age,lastname,firstname,companyname FROM studinfo WHERE yeargraduated LIKE '$companyId' ORDER by lastname ASC");
...
function getcookie(){
	...
	document.getElementById("tblhead").innerHTML = "STUDENTS GRADUATED FROM "  + getcookie();
//}
